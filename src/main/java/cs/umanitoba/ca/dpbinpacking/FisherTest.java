...
public class FisherTest {
    ...
    static double SMALLISH_EPSILON = 0.00000000003;
    static double SMALL_EPSILON = 0.0000000000001;
    static double EXACT_TEST_BIAS = 0.00000000000000000000000010339757656912845935892608650874535669572651386260986328125;
    static int dir = 0;

    public static double fisher23(double m11, double m12, double m13, double m21, double m22, double m23, double midp) {
    ...
    private static int fisher23_tailsum(double base_probp, double saved12p, double saved13p, double saved22p, double saved23p, double totalp, int tie_ctp, int right_side) {
        double total = 0;
